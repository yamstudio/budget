            ...
            <Layout style={{ height: '100vh', display: 'flex' }}>
                ...
                <Content style={{ flex: 1, display: 'flex' }}>
                    <Routes>
                        ...
                        <Route path='/expenses' element={<Expenses fromDate={fromDate} toDate={toDate} expenseCategories={expenseCategories} vendors={vendors} paymentMethods={paymentMethods}/>}/>
                        <Route path='/incomes' element={<Incomes fromDate={fromDate} toDate={toDate} incomeSources={incomeSources} incomeCategories={incomeCategories}/>}/>
